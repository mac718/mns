...
import styles from "./properties_benefits.module.css";

export default function PropertiesBenefits() {
  return (
    <>
      <div className={styles.main}>
        ...
        <p>
          <strong>
            I use a wide range of oils and butters in my cold and hot processed
            soaps. Though all of them are great for the skin and hair, they each
            have their own role to play in the soaps and shampoo bars that
            contain them.
          </strong>
        </p>
        ...
        <p>
          ...
          - Solid below temperatures of 76 degrees, this oil is one of the few
          that offers significant cleansing properties due to its high lauric
          acid content. However, as a result, too much can be drying, since it
          has the potential to strip the skin of its natural oils. But, used
          judiciously, it is very skin-friendly. It also imparts hardness and a
          nice fluffy lather to each bar.
        </p>
        ...
        <p>
          ...
          - A highly prized hard, dense, emollient vegetable butter of Indian
          origin derived from the fruit of the Garcinia tree. Kokum butter
        ...
        <p>
          ...
          - An oil with a long soaping history, olive oil provides great
          conditioning for the skin and is extremely mild. Soap made with 50%
          olive oil or more is known as castile soap, named after the region of
          Spain in which it was allegedly invented.
        </p>
        ...
        <p>
          ...
          - Palm oil is a great soap base in combination with other oils that
          lends hardness and a stable, creamy lather to soaps.
        </p>
        ...
        <p>
          ...
          - A very light, silky, highly moisturizing, and gentle oil that
          promotes a stable lather.
        </p>
        ...
        <p>
          ...
          - This is an acid that is found in other oils and butters, most
          prominently in shea, mango, kokum, and cocoa butters, and beef tallow
          (however, my stearic acid is ENTIRELY OF VEGETABLE ORIGIN) that adds
          creaminess and hardness to soap. I use this in my shaving soaps and
          some shampoo bars to enhance the texture of the lather.
        </p>

        <p>
          <strong>
            <u>Vegetable Glycerin</u>
          </strong>{" "}
          ...
          throughout the shave. In addition, glycerin makes shaving lather
          stronger and less subject to breakdown.
        </p>
      </div>
      <Footer />
    </>
